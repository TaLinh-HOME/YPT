            ...
            <div class="iq-navbar-custom">
                <nav class="navbar navbar-expand-lg navbar-light p-0">
                    <div class="iq-navbar-logo d-flex align-items-center justify-content-between"><i class="ri-menu-line wrapper-menu"></i>
                        <a href="/home" class="header-logo"><img src="<?=$NHQ->site('logo');?>" class="img-fluid rounded-normal light-logo" alt="logo"><img src="<?=$NHQ->site('logo');?>" class="img-fluid rounded-normal darkmode-logo" alt="logo">
                        </a>
                    </div>
                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb iq-bg-danger">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Lấy uid facebook</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <form submit-ajax="nhq" action="<?=BASE_URL('api/tool/get-uid');?>" method="post" api_token="<?=$NHQ->getUsers('token');?>">
                                    <div class="row">
