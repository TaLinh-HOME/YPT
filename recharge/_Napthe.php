                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb iq-bg-danger">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Nạp tiền thẻ cào</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-6"><a href="<?=BASE_URL('recharge/card');?>" class="btn btn-primary btn-block">Thẻ cào</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <form submit-ajax="nhq" action="<?=BASE_URL('api/recharge/card');?>" method="post" api_token="<?=$NHQ->getUsers('token');?>">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-4 mr-auto ml-auto pt-3">
                                            <button type="submit" class="btn btn-primary btn-block"><em class="fa fa-paper-plane"></em> Nạp ngay</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="table-responsive scrollbar">
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                                        <table class="table table-bordered table-striped fs--1 mb-3 dataTables-nhq dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            ...
                                            <tbody>
                                                <?php $getlistcard = $NHQ->get_list("SELECT * FROM `history_naptien` WHERE `type` = 'napthe' AND `username` = '$my_user' ORDER BY `id` DESC "); if($getlistcard){ foreach($getlistcard as $rowucard){?>
                                                <tr class="odd">
                                                    <td><?=$rowucard['id']?></td>
