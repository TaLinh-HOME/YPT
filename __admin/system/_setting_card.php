                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb iq-bg-danger">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Cài đặt dòng tiền card</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form submit-ajax="nhq" action="<?=BASE_URL('api/admin/recharge/card/edit');?>" method="post" api_token="<?=$NHQ->getUsers('token');?>">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Site nạp thẻ</label>
                                                <select class="form-control" name="sitenapthe">
                                                    <option value="<?=$NHQ->site('site_napthe');?>"><?=sitenapthe($NHQ->site('site_napthe'));?></option>
                                                    <option value="trumthe">Trumthe.vn</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?=$NHQ->site('cuphap');?>" name="cuphapnap" placeholder="Nhập cú pháp nạp tiền">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Partner ID:</label>
                                                <input type="text" class="form-control" name="PartnerID" value="<?=$NHQ->site('partner_id');?>" require>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Partner KEY:</label>
                                                <input type="text" class="form-control" name="PartnerKEY" value="<?=$NHQ->site('partner_key');?>" require>
                                            </div>
                                        </div>
