                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb iq-bg-danger">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Cài đặt momo auto</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form submit-ajax="nhq" action="<?=BASE_URL('api/admin/recharge/momoauto/add');?>" method="post" api_token="<?=$NHQ->getUsers('token');?>">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Số điện thoại momo:</label>
                                                <input type="text" class="form-control" name="PartnerID" value="<?=$NHQ->site('partner_id');?>" require>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Mật khẩu momo:</label>
