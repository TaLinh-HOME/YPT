                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb iq-bg-danger">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Cài đặt thông tin admin</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form submit-ajax="nhq" action="<?=BASE_URL('api/admin/info/admin/edit');?>" method="post" api_token="<?=$NHQ->getUsers('token');?>">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Tên admin</label>
                                                <input type="text" class="form-control" value="<?=$NHQ->site('full_name_admin');?>" name="nameadmin"></input>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Phone zalo:</label>
                                                <input type="text" class="form-control" value="<?=$NHQ->site('phone_zalo');?>" name="phonezalo">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Link facebook:</label>
                                                <input type="text" class="form-control" name="facebook" value="<?=$NHQ->site('facebook');?>" require>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">UID facebook:</label>
                                                <input type="text" class="form-control" name="UIDfacebook" value="<?=$NHQ->site('id_page');?>" require>
                                            </div>
                                        </div>
