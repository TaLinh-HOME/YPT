                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb iq-bg-danger">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Sửa thông báo nổi</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <form submit-ajax="nhq" action="<?=BASE_URL('api/admin/thongbao/home/add');?>" method="post" api_token="<?=$NHQ->getUsers('token');?>">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <center><label class="form-label" for="">Nhập thông báo nổi</label></center>
                                                <textarea  type="number" rows="5" cols="50" class="form-control" name="thongbaonoi"><?=$NHQ->site('thongbao');?></textarea>
                                            </div>
                                        </div>
