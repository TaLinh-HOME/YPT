                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb iq-bg-danger">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Sửa server dịch vụ </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <?php $getsvdv = $NHQ->get_row("SELECT * FROM `server_service` WHERE `id` = '".$_GET['id']."'")?>
                                <form submit-ajax="nhq" action="<?=BASE_URL('');?>api/admin/service/quanly/facebook/editsv" method="post" api_token="<?=$NHQ->getUsers('token');?>">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Loại dịch vụ (Không được sửa mục này):</label>
                                                <input type="text" class="form-control" value="<?=$getsvdv['code_service'];?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="">Server (Không được sửa mục này):</label>
                                                <input type="text" class="form-control" value="<?=$getsvdv['server_service'];?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" name="idsv" value="<?=$_GET['id']?>" require>
