...
// $selectservice = $NHQ->get_row("SELECT * FROM `rate_service` WHERE `code_service` = 'comment_sale' AND `status_service` = '1' "); 
$getrate = $NHQ->get_list("SELECT * FROM `server_service` WHERE `code_service` = 'comment_sale' AND `status_service` = '1' ");
}?>
                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb iq-bg-danger">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Tăng comment sale Facebook</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-6"><a href="<?=BASE_URL('service/comment-sale/buy');?>" class="btn btn-primary btn-block">Thêm đơn</a>
                                    </div>
                                    <div class="col-6"><a href="<?=BASE_URL('service/comment-sale/list');?>" class="btn btn-outline-primary btn-block">Danh sách đơn</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form submit-ajax="nhq" action="<?=BASE_URL('api/service/comment-sale');?>" method="post" api_token="<?=$NHQ->getUsers('token');?>">
                                    <div class="form-group row">
                                        <label for="" class="col-md-3">Link bài viết </label>
                                        <div class="col-md-9">
                                            <input type="url" class="form-control mb-3" name="link_post" placeholder="Nhập link bài viết cần tăng">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="alert bg-primary alert-dismissible fade show fs--1 text-center" role="alert"> Tổng tiền = (Số lượng) x (Giá 1 like) </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="" class="col-md-3">Nội dung bình luận </label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" name="note_cmt" rows="5" placeholder="Nhập nội dung cần bình luận, mỗi bình luận là 1 dòng"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
