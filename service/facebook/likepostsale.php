...
// $selectservice = $NHQ->get_row("SELECT * FROM rate_service WHERE code_service = 'like_post_sale' AND status_service = '1' "); 
$getrate = $NHQ->get_list("SELECT * FROM server_service WHERE code_service = 'like_post_sale' AND status_service = '1' ");
}?>
                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-6"><a href="<?=BASE_URL('service/like-post-sale/buy');?>" class="btn btn-primary btn-block">Thêm đơn</a>
                                    </div>
                                    <div class="col-6"><a href="<?=BASE_URL('service/like-post-sale/list');?>" class="btn btn-outline-primary btn-block">Danh sách đơn</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form submit-ajax="nhq" action="<?=BASE_URL('api/service/like-post-sale');?>" method="post" api_token="<?=$NHQ->getUsers('token');?>">
