                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            <div class="card-header">
                                <h5 class="mb-0 text-center">Tạo website con</h5>
                            </div>
                            <div class="card-body">
                                <div class="alert text-white bg-warning" role="alert"> - Bạn phải đạt cấp bậc cộng tác viên hoặc đại lý mới có thể tạo web con nhé!
                                    <br> - Nghiêm cấm các tiên miền có chữ : Facebook, Instagram để tránh bị vi phạm bản quyền.
                                    <br> - Khách hàng tạo tài khoản và sử dụng dịch vụ ở site con. Tiền sẽ trừ vào tài khoản của đại lý ở site chính. Vì thế để khách hàng mua được tài khoản đại lý phải còn số dư.
                                    <br> - Chúng tôi hỗ trợ mục đích kinh doanh của tất cả cộng tác viên và đại lý! </div>
                                <div class="row">
                                    <div class="col-md-6 mr-auto ml-auto">
                                        <form submit-ajax="nhq" action="<?=BASE_URL('api/website/create');?>" method="post" api_token="<?=$NHQ->getUsers('token');?>">
                                            <?php $checksc = $NHQ->get_row("SELECT * FROM `list_sitecon` WHERE `username` = '$my_user'"); if(!$checksc){?>
                                            <div class="form-group col-md-12">
                                                <label for="">Tên miền</label>
                                                <div class="input-group">
                                                    <input class="form-control" type="text" name="domain" value="" placeholder="Nhập tên miền cần kích hoạt">
                                                    <div class="input-group-append">
                                                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Tạo ngay</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php }else{?>
                                            <div class="form-group col-md-12">
                                                <label for="">Bạn đã tạo site con:</label>
                                                <p>Domain: <?=$checksc['domain']?></p>
                                                <p>Token site: <?=$checksc['token']?></p>
                                            </div>
                                            <?php }?>
                                        </form>
                                        <div class="form-group">
                                            <div class="alert text-white bg-success d-flex align-items-center" role="alert">
                                                <div class="flex-fill ml-3 overflow-hidden page_speed_1934073510"><strong class="text-dark">Thêm tên miền xong vui lòng liên hệ cho Admin để được kích hoạt!</strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
