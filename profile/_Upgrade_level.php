                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb iq-bg-danger">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Nâng cấp bậc</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="table-responsive pricing pt-2">
                                    <table id="my-table" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center prc-wrap">
                                                    <div class="prc-box active">
                                                        <div class="h3 pt-4">Thành viên</div><span class="type">Thường</span>
                                                    </div>
                                                </th>
                                                <th class="text-center prc-wrap">
                                                    <div class="prc-box ">
                                                        <div class="h3 pt-4">Cộng tác viên</div><span class="type">Vip</span>
                                                    </div>
                                                </th>
                                                <th class="text-center prc-wrap">
                                                    <div class="prc-box ">
                                                        <div class="h3 pt-4">Đại lý</div><span class="type">Cực Vip</span>
                                                    </div>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                <th class="text-center" scope="row">Tài liệu API</th>
                                                <td class="text-center child-cell"><i class="ri-check-line ri-2x"></i>
                                                </td>
                                                <td class="text-center child-cell "><i class="ri-check-line ri-2x"></i>
                                                </td>
                                            ...
                                            <tr>
                                                <th class="text-center" scope="row">Giá dịch vụ riêng</th>
                                            ...
                                            <tr>
                                                <th class="text-center" scope="row">Website riêng</th>
                                                <td class="text-center child-cell"><i class="ri-close-line i_close"></i>
                                                </td>
                                                <td class="text-center child-cell"><i class="ri-check-line ri-2x"></i>
                                                </td>
                                            ...
                                            <tr>
                                                <th class="text-center" scope="row">Box hỗ trợ riêng</th>
                                                <td class="text-center child-cell"><i class="ri-close-line i_close"></i>
                                                </td>
                                                <td class="text-center child-cell"><i class="ri-close-line i_close"></i>
                                                </td>
                                            ...
                                            <tr>
                                                <th class="text-center" scope="row">Mức nạp/1 tháng</th>
                                                <td class="text-center child-cell"><b class="text-danger">0</b><sup>Coin</sup>
                                                </td>
                                                <td class="text-center child-cell"><b class="text-danger"><?=number_format($NHQ->site('rate_ctv'))?></b><sup>Coin</sup>
                                                </td>
                                                <td class="text-center child-cell"><b class="text-danger"><?=number_format($NHQ->site('rate_daily'))?></b><sup>Coin</sup>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form submit-ajax="nhq" action="<?=BASE_URL('api/profile/upgrade-level');?>" method="post" api_token="<?=$NHQ->getUsers('token');?>">
