            ...
            <div class="container-fluid">
                   ...
                   <div class="card car-transparent">
                     <div class="card-body p-0">
                        <div class="profile-image position-relative">
                           <img src="/assets/images/bg.png" alt="" class="page_speed_834103319 img-fluid rounded w-100">
                             </div>
                                <div class="profile-overly">
                                    <h4><?=$NHQ->getUsers('username');?></h4><span><?=levelmem($NHQ->getUsers('capbac'));?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-body">
                                <h6 class="card-title mb-3">Thông tin</h6>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="">Họ và tên</label>
                                        <input type="text" class="form-control" value="<?=$NHQ->getUsers('name');?>" readonly="">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Email</label>
                                        <input type="text" class="form-control" value="<?=$NHQ->getUsers('email');?>" readonly="">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Cấp độ</label>
                                        <input type="text" class="form-control" value="<?=levelmem($NHQ->getUsers('capbac'));?>" readonly="">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Thời gian tham gia</label>
                                        <input type="text" class="form-control" value="<?=$NHQ->getUsers('date');?>" readonly="">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="">Api Token</label>
                                        <div class="input-group">
                                            <input class="form-control" type="text" value="<?=$NHQ->getUsers('token');?>" readonly="">
                                            <div class="input-group-append">
                                                <form submit-ajax="nhq" method="post" action="<?=BASE_URL('api/profile/change-token');?>" api_token="<?=$NHQ->getUsers('token');?>">
                                                    <button type="submit" class="btn btn-primary"><i class="fa fa-exchange-alt"></i> Thay đổi</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-body">
                                <h6 class="card-title mb-3">Đổi mật khẩu</h6>
                                <form submit-ajax="nhq" action="<?=BASE_URL("api/profile/info/pass");?>" method="post" api_token="<?=$NHQ->getUsers('token')?>" href="/auth/logout">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                            <button type="submit" class="btn btn-primary btn-lg btn-block"><i class="fa fa-lock"></i> Thay đổi</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
